...
echo " G2P Conversion, generating lexicon"
  ...
  phonetisaurus-apply --model $g2ps/turkish.fst --word_list $dict_dir/tr/word_list > $dict_dir/tr/lexicon.txt

# Lexicon correction
cat $dict_dir/tr/lexicon.txt | awk '{$1=""; print $0}' | sed -e 's/d ʒ/d͡ʒ/g; s/dʒ/d͡ʒ/g; s/t ʃ/t͡ʃ/g; s/tʃ/t͡ʃ/g; s/ɡj/ɡ/g; s/g/ɡ/g; s/â/a/g; s/é/e/g; s/û/u/g; s/*//g; s/ ̇//g; s/[.]//g; s/ë/e/g; s/î/i/g' > $dict_dir/tr/phone.txt
