...
| [`b`](https://cat-ckpt.oss-cn-beijing.aliyuncs.com/cat-multilingual/cv-lang10/dict/IPA_audio/b.mp3) | [pu`b`blicizzò](https://cat-ckpt.oss-cn-beijing.aliyuncs.com/cat-multilingual/cv-lang10/dict/it/word_audio/pubblicizzò.mp3) | p `b` b l i t͡ʃ t͡s d͡z ɔ |  |
...
| [`dz`](https://cat-ckpt.oss-cn-beijing.aliyuncs.com/cat-multilingual/cv-lang10/dict/IPA_audio/dz.mp3) | [pubbliciz`z`ò](https://cat-ckpt.oss-cn-beijing.aliyuncs.com/cat-multilingual/cv-lang10/dict/it/word_audio/pubblicizzò.mp3) | p b b l i t͡ʃ t͡s `d͡z` ɔ | The same pronunciation for `/dz/` and `/d͡z/`, so replacing `/dz/` with `/d͡z/` |
...
| [`i`](https://cat-ckpt.oss-cn-beijing.aliyuncs.com/cat-multilingual/cv-lang10/dict/IPA_audio/i.mp3) | [pubbl`i`cizzò](https://cat-ckpt.oss-cn-beijing.aliyuncs.com/cat-multilingual/cv-lang10/dict/it/word_audio/pubblicizzò.mp3) | p b b l `i` t͡ʃ t͡s d͡z ɔ |  |
...
| [`l`](https://cat-ckpt.oss-cn-beijing.aliyuncs.com/cat-multilingual/cv-lang10/dict/IPA_audio/l.mp3) | [pubb`l`icizzò](https://cat-ckpt.oss-cn-beijing.aliyuncs.com/cat-multilingual/cv-lang10/dict/it/word_audio/pubblicizzò.mp3) | p b b `l` i t͡ʃ t͡s d͡z ɔ |  |
...
| [`ɔ`](https://cat-ckpt.oss-cn-beijing.aliyuncs.com/cat-multilingual/cv-lang10/dict/IPA_audio/ɔ.mp3) | [pubblicizz`ò`](https://cat-ckpt.oss-cn-beijing.aliyuncs.com/cat-multilingual/cv-lang10/dict/it/word_audio/pubblicizzò.mp3) | p b b l i t͡ʃ t͡s d͡z `ɔ` |  |
| [`p`](https://cat-ckpt.oss-cn-beijing.aliyuncs.com/cat-multilingual/cv-lang10/dict/IPA_audio/p.mp3) | [`p`ubblicizzò](https://cat-ckpt.oss-cn-beijing.aliyuncs.com/cat-multilingual/cv-lang10/dict/it/word_audio/pubblicizzò.mp3) | `p` b b l i t͡ʃ t͡s d͡z ɔ |  |
...
| [`tʃ`](https://cat-ckpt.oss-cn-beijing.aliyuncs.com/cat-multilingual/cv-lang10/dict/IPA_audio/tʃ.mp3) | [pubbli`ci`zzò](https://cat-ckpt.oss-cn-beijing.aliyuncs.com/cat-multilingual/cv-lang10/dict/it/word_audio/pubblicizzò.mp3) | p b b l i `t͡ʃ` t͡s d͡z ɔ | The same pronunciation for `/tʃ/` and `/t͡ʃ/`, so replacing `/tʃ/` with `/t͡ʃ/` |
| [`ts`](https://cat-ckpt.oss-cn-beijing.aliyuncs.com/cat-multilingual/cv-lang10/dict/IPA_audio/ts.mp3) | [pubblici`z`zò](https://cat-ckpt.oss-cn-beijing.aliyuncs.com/cat-multilingual/cv-lang10/dict/it/word_audio/pubblicizzò.mp3) | p b b l i t͡ʃ `t͡s` d͡z ɔ | The same pronunciation for `/ts/` and `/t͡s/`, so replacing `/ts/` with `/t͡s/` |
