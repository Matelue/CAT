...
| [`e`](https://cat-ckpt.oss-cn-beijing.aliyuncs.com/cat-multilingual/cv-lang10/dict/IPA_audio/e.mp3) | [pos`é`idocroiseurs](https://cat-ckpt.oss-cn-beijing.aliyuncs.com/cat-multilingual/cv-lang10/dict/fr/word_audio/poséidocroiseurs.mp3) | p ɔ z `e` i d ɔ k ʁ w a z œ ʁ |  |
