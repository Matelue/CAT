...
* To train tokenizer:
        ...
        `bash run.sh id exp/Crosslingual/id/Wav2vec-lang10_ft_bpe_id_10h --sta 1 --sto 1`
* To fine-tune the model:

        `bash run.sh id exp/Crosslingual/id/Wav2vec-lang10_ft_bpe_id_10h --sta 2 --sto 3`
* To plot the training curves:

        `python utils/plot_tb.py exp/Crosslingual/id/Wav2vec-lang10_ft_bpe_id_10h/log/tensorboard/file -o exp/Crosslingual/id/Wav2vec-lang10_ft_bpe_id_10h/monitor.png`
...
* To decode with CTC and calculate the %PER:
        ...
        `bash run.sh id exp/Crosslingual/id/Wav2vec-lang10_ft_bpe_id_10h/ --sta 4 --sto 4`
...
* To train a language model:
        ...
        `bash run.sh id exp/Crosslingual/id/Wav2vec-lang10_ft_bpe_id_10h/ --mode subword --sta 5 --sto 5`

* To decode with FST and calculate the %WER:

        `bash run.sh id exp/Crosslingual/id/Wav2vec-lang10_ft_bpe_id_10h/ --mode subword --sta 6`
...
* The files used to fine-tune this model and the fine-tuned model are available in the following table.
    ...
    | ----------- | ----------- | ----------- | ----------- |
    | [`wordlist_id.txt`](https://cat-ckpt.oss-cn-beijing.aliyuncs.com/cat-multilingual/cv-lang10/dict/id/wordlist_id.txt) | [`Wav2vec-lang10_ft_bpe_id_10h_best-3.pt`](https://cat-ckpt.oss-cn-beijing.aliyuncs.com/cat-multilingual/cv-lang10/exp/id/Wav2vec-lang10_ft_bpe_id_10h_best-3.pt) | [`lm_id.arpa`](https://cat-ckpt.oss-cn-beijing.aliyuncs.com/cat-multilingual/cv-lang10/exp/id/lm_id.arpa) | [`tb_Wav2vec-lang10_ft_bpe_id_10h`](https://cat-ckpt.oss-cn-beijing.aliyuncs.com/cat-multilingual/cv-lang10/exp/id/tb_Wav2vec-lang10_ft_bpe_id_10h) |
