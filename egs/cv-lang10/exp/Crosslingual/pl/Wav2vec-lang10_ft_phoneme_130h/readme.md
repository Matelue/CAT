...
* To train tokenizer:
        ...
        `bash run.sh pl exp/Crosslingual/pl/Wav2vec-lang10_ft_phoneme_pl_130h --sta 1 --sto 1`
* To fine-tune the model:

        `bash run.sh pl exp/Crosslingual/pl/Wav2vec-lang10_ft_phoneme_pl_130h --sta 2 --sto 3`
* To plot the training curves:

        `python utils/plot_tb.py exp/Crosslingual/pl/Wav2vec-lang10_ft_phoneme_pl_130h/log/tensorboard/file -o exp/Crosslingual/pl/Wav2vec-lang10_ft_phoneme_pl_130h/monitor.png`
...
* To decode with CTC and calculate the %PER:
        ...
        `bash run.sh pl exp/Crosslingual/pl/Wav2vec-lang10_ft_phoneme_pl_130h/ --sta 4 --sto 4`
...
* To train a language model:
        ...
        `bash run.sh pl exp/Crosslingual/pl/Wav2vec-lang10_ft_phoneme_pl_130h/ --sta 5 --sto 5`

* To decode with FST and calculate the %WER:

        `bash run.sh pl exp/Crosslingual/pl/Wav2vec-lang10_ft_phoneme_pl_130h/ --sta 6`
...
* The files used to fine-tune this model and the fine-tuned model are available in the following table.
    ...
    | ----------- | ----------- | ----------- | ----------- |
    | [`wordlist_pl.txt`](https://cat-ckpt.oss-cn-beijing.aliyuncs.com/cat-multilingual/cv-lang10/dict/pl/wordlist_pl.txt) | [`Wav2vec-lang10_ft_phoneme_pl_130h_best-3.pt`](https://cat-ckpt.oss-cn-beijing.aliyuncs.com/cat-multilingual/cv-lang10/exp/pl/Wav2vec-lang10_ft_phoneme_pl_130h_best-3.pt) | [`lm_pl.arpa`](https://cat-ckpt.oss-cn-beijing.aliyuncs.com/cat-multilingual/cv-lang10/exp/pl/lm_pl.arpa) | [`tb_Wav2vec-lang10_ft_phoneme_pl_130h`](https://cat-ckpt.oss-cn-beijing.aliyuncs.com/cat-multilingual/cv-lang10/exp/pl/tb_Wav2vec-lang10_ft_phoneme_pl_130h) |
