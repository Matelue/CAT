...
* To fine-tune the mT5-base model:
        ...
        `bash run.sh pl exp/danp/pl/top-8-beam --sta 2 --sto 3`
* To plot the training curves:

        `python utils/plot_tb.py exp/danp/pl/top-8-beam/log/tensorboard/file -o exp/danp/pl/top-8-beam/monitor.png`
...
* To decode with AED and calculate the %WER:
        ...
        `bash run.sh pl exp/danp/pl/top-8-beam --sta 4 --sto 4`
...
To rescoring and calculate the %WER:
        ...
        `bash run.sh pl exp/danp/pl/top-8-beam --sta 5`
