...
* To fine-tune the mT5-base model:
        ...
        `bash run.sh pl exp/danp/pl/random-8-of-32-beam_20h --sta 2 --sto 3`
* To plot the training curves:

        `python utils/plot_tb.py exp/danp/pl/random-8-of-32-beam_20h/log/tensorboard/file -o exp/danp/pl/random-8-of-32-beam_20h/monitor.png`
...
* To decode with AED and calculate the %WER:
        ...
        `bash run.sh pl exp/danp/pl/random-8-of-32-beam_20h --sta 4 --sto 4`
...
To rescoring and calculate the %WER:
        ...
        `bash run.sh pl exp/danp/pl/random-8-of-32-beam_20h --sta 5`
