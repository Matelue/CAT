...
* To fine-tune the mT5-base model:
        ...
        `bash run.sh de exp/danp/de/random-8-sample-T --sta 2 --sto 3`
* To plot the training curves:

        `python utils/plot_tb.py exp/danp/de/random-8-sample-T/log/tensorboard/file -o exp/danp/de/random-8-sample-T/monitor.png`
...
* To decode with AED and calculate the %WER:
        ...
        `bash run.sh de exp/danp/de/random-8-sample-T --sta 4 --sto 4`
...
To rescoring and calculate the %WER:
        ...
        `bash run.sh de exp/danp/de/random-8-sample-T --sta 5`
